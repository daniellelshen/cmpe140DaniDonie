module mips_fpga (
    ...
    */
    ...
    switches[8:5] = 0100 : Display lower  half word of 'result'
    switches[8:5] = 0101 : Display higher half word of 'result'
    ...
    */
    always @ (posedge clk) begin
        case ({switches[8:5]})
            ...
            4'b0100: reg_hex = result[15:0];
            4'b0101: reg_hex = result[31:16];
